 ...
 *
 * @brief Common frontend site header - Customized for Editorial Management System
 * This version removes the search icon and menu from the navigation bar.
 *
				...
				<nav class="pkp_site_nav_menu" aria-label="{translate|escape key="common.navigation.site"}">
					...
					<div class="pkp_navigation_primary_row">
						<div class="pkp_navigation_primary_wrapper">
							...
							{* Search form - REMOVED for Editorial Management System *}
						</div>
					</div>
